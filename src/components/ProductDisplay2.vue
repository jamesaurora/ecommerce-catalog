...
export default {
  ...
  try {
    ...
    // Karena API ini mengembalikan seluruh kategori pria, kita perlu memilih produk dengan index currentIndex
    this.product = data[this.currentIndex - 1]; 
  } catch (error) {
...
<style>
@import url('/src/assets/style/page2.css');
